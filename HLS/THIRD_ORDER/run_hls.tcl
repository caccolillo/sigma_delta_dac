# =============================================================================
# run_hls.tcl
# Vitis HLS automation script for the 3rd-order CIFB SDM
#
# Usage:
...
add_files sdm_cifb_3rd.h -cflags "-std=c++14"

# Testbench files
add_files -tb sdm_cifb_3rd_tb.cpp -cflags "-std=c++14"
...
puts "==============================================="
export_design -format ip_catalog -display_name "SDM CIFB 3rd Order"
